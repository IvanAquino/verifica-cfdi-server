...
<head>
    ...
    <title>Verifica CFDI Server</title>
...
<body
    ...
    <div
        ...
        <main class="w-full max-w-lg">
            <section
                class="bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-xl px-8 py-8 lg:p-10">
                <span
                    class="inline-flex items-center gap-2 text-xs font-medium uppercase tracking-wider text-[#706f6c] dark:text-[#A1A09A] mb-4">
                    <span class="size-2.5 rounded-full bg-[#f53003] dark:bg-[#F61500]"></span>
                    Acceso restringido
                </span>

                <h1 class="text-lg font-semibold text-[#1b1b18] dark:text-white mb-3">
                    Proyecto privado de verificación CFDI
                </h1>

                <p class="text-sm leading-normal text-[#706f6c] dark:text-[#A1A09A] mb-4">
                    Este sistema es de uso interno y está destinado exclusivamente al equipo autorizado
                    de Verifica CFDI. Para continuar, inicia sesión con tus credenciales asignadas.
                </p>

                <div
                    class="border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg px-5 py-4 bg-[#FDFDFC] dark:bg-[#1D0002] mb-6">
                    <h2 class="text-sm font-medium text-[#1b1b18] dark:text-white mb-1">
                        ¿No tienes acceso?
                    </h2>
                    <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">
                        Contacta al administrador del proyecto para solicitar permisos o resolver dudas
                        sobre tu cuenta.
                    </p>
                </div>
                ...
                <div class="flex flex-col gap-3">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="inline-flex items-center justify-center gap-2 px-5 py-2 text-sm font-medium text-white bg-[#1b1b18] hover:bg-black rounded-md transition-all">
                            Ir al dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center justify-center gap-2 px-5 py-2 text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] border border-[#19140035] dark:border-[#3E3E3A] hover:border-[#1915014a] dark:hover:border-[#62605b] rounded-md transition-all">
                                Solicitar acceso
                            </a>
                        @endif
                    @endauth
